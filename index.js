// const { app, Datastore } = require('codehooks-js');
...
app.post('/chat', async (req, res) => {
    if (!process.env.chatGptKey) return res.status(500).end('Please add your OPENAI_API_KEY'); // CLI command: coho set-env OPENAI_API_KEY 'XXX' 
    const { ask } = req.body;
